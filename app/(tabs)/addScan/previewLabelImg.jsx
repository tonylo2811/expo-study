...
export default function previewLabelImg() {
    const route = useRoute();
    const {labelImgUri} = route.params;
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                <Image style={styles.img} source={{uri: labelImgUri}} />
            </View>

            <View style={styles.ctrlContainer}>
                <View style={styles.ctrlRow}>
                    <Link href="/addScan/labelCamera" asChild>
                    ...
                    <TouchableOpacity 
                        style={styles.cfmBtn}
                        onPress={async () => {
                            const cfmLabelImg = await convertBase64(labelImgUri);
                            navigation.navigate("index", {cfmLabelImg});
                        }}
                    >
