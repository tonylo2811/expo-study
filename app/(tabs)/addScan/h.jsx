import { Text, View, Button, Pressable, StyleSheet, TextInput, Image, TouchableOpacity, FlatList, ScrollView} from "react-native";
...
export default function App() {
  ...
  let categoriesBtnList = ["Top", "Outerwear", "Pants", "Overall", "Dress", "Skirt", "Other"]; 

  const categoriesList = () => {
    return (
      <FlatList data={categoriesBtnList} numColumns={4}
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.button} onPress={handleCategoriesBtn}>
